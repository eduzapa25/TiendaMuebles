$(document).ready(function() {
    ...
    $('#formDatos').submit(function(event) {
        ...
        if($(this).find('#rol').val()==""){
            errorPassword += "<span>*No deje el campo vacio</span>";
            error = true;
        }
        else if($(this).find('#rol').val()!="trabajador" && $(this).find('#rol').val()!="admin" && $(this).find('#rol').val()!="cliente"){
            errorRol += "<span>*Ha introducido un rol erroneo</span>";
            error = true;
        }
